...
var upload = require('../config/multer')
    ...
    app.get('/noticias_excluir', async(req, res)=>{
        var id = req.query.id

        var busca = await noticias.findOne({_id:id})

        res.render('noticias_excluir.ejs', {dados:busca})
    })

    app.post('/noticias_excluir', async(req, res)=>{
        var id = req.query.id
        ...
        var excluir = await noticias.findOneAndRemove({_id:id})
